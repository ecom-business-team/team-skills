...
GENERAL — recommended for everyone
  ✓ general           General-purpose skills (new-workflow, onboard, team-skills-add, team-skills-browse)
...
curl -sL https://api.github.com/repos/ecom-business-team/team-skills/contents/plugins/<plugin>/skills
```
