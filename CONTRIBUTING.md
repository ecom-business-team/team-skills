...
A skill can be merged into this marketplace when it clears every item on this checklist. The `/team-skills-add` command walks you through it — you don't need to check them manually.
...
You do not need to know git. Use `/team-skills-add` in Claude Code:
